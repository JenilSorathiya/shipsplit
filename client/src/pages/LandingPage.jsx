        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-lg text-gray-500">
              ...
              <a href="mailto:jpenterprise143@gmail.com" className="text-primary-600 hover:underline">
                Email us
              </a>
            </p>
          </div>
      ...
      <section className="bg-gray-900 py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="mailto:jpenterprise143@gmail.com"
      ...
      <footer className="bg-gray-950 text-gray-400 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 pb-12 border-b border-gray-800">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-gray-400 mb-4">
                A product by <span className="text-gray-300 font-semibold">J P Enterprise</span>
              </p>
              <p className="text-xs text-gray-600">
                © 2026 J P Enterprise. All rights reserved.
              </p>
            </div>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
            <span>© 2026 J P Enterprise · ShipSplit is a product of J P Enterprise · Made with ❤️ in India</span>
            <span>Contact: jpenterprise143@gmail.com</span>
          </div>
        </div>
      </footer>
